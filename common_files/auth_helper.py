...
from common_files import output_helper

# Required
DEVELOPER_TOKEN='116CT48D22861292' # Universal token for sandbox
...
CLIENT_ID='3253628c-66d9-4407-894b-3d82a9ca2b33'
...
def authenticate(authorization_data):
    ...
    os.system('cp refresh.txt /tmp/refresh.txt')
